...
public class Place extends edu.uiowa.slis.FAST.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (this.getParent() instanceof edu.uiowa.slis.FAST.GeoCoordinates.GeoCoordinatesGeoInverseIterator) {
				subjectURI = ((edu.uiowa.slis.FAST.GeoCoordinates.GeoCoordinatesGeoInverseIterator)this.getParent()).getGeoInverse();
			}
