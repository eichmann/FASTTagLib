...
public class PlaceGeo extends edu.uiowa.slis.FAST.TagLibSupport {
	static PlaceGeo currentInstance = null;
	private static final Log log = LogFactory.getLog(PlaceGeo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePlaceGeoIterator.getGeo());
		} catch (Exception e) {
