...
public class GeoCoordinatesIterator extends edu.uiowa.slis.FAST.TagLibSupport {
	static GeoCoordinatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeoCoordinatesIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://schema.org/GeoCoordinates> . "+
